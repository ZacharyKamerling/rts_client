class Missile {
    ...
    decode(c: Cereal, time: number, frame: number, exploding: boolean) {
    ...
    step(timeDelta: number, oldMisl: Missile, newMisl: Missile) {
    ...
    static decodeMissile(game: Game, data: Cereal, time: number, frame: number, exploding: boolean) {
